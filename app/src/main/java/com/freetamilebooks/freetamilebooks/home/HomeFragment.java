...
import com.freetamilebooks.freetamilebooks.app.ConnectionDetector;
...
import com.freetamilebooks.freetamilebooks.utils.FTELog;
...
import com.freetamilebooks.freetamilebooks.webservice.FTERequestHandler;
...
public class HomeFragment extends BaseFragment implements HomeItemListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init(View view) {
        ...
        booksHomeAdapter = new BooksHomeAdapter(new ArrayList<BooksHomeParser.Books.Book>(), HomeFragment.this, getActivity());
    ...
    private void showBookList(String bookResponse) {
        ...
        booksHomeAdapter = new BooksHomeAdapter(booksHomeListParser.books.book, HomeFragment.this, getActivity());
        booksHomeAdapter.setListItemListener(HomeFragment.this);
