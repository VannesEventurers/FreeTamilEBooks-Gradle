...
public class BooksHomeAdapter extends BaseAdapter implements OnScrollListener {
    ...
    public BooksHomeAdapter(ArrayList<BooksHomeParser.Books.Book> bookList, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.txtBookTitle = (TextView) layout.findViewById(R.id.txt_title);
            holder.txtAuthorName = (TextView) layout.findViewById(R.id.txt_author);
            holder.ivBookIcon = (ImageView) layout.findViewById(R.id.iv_book_image);
            holder.ivProgress = (ProgressBar) layout.findViewById(R.id.iv_progress);

            holder.baseLayout = (LinearLayout) layout.findViewById(R.id.base_layout);
            holder.btnDownload = (TextView) layout.findViewById(R.id.btn_down);
            holder.btnOpen = (TextView) layout.findViewById(R.id.btn_open);
